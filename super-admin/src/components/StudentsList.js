  ...
  return (
    <div className="container mx-auto px-4 py-4">
      ...
      <div className="overflow-x-auto ">
        <table className="min-w-full text-sm text-left text-gray-900 white:text-white-400">
          <thead className="text-xs  text-gray-100 uppercase dark:bg-indigo-500"  style={{ background: 'linear-gradient(to right, rgb(36, 18, 101) 0%, rgb(0, 130, 203) 100%)', color: 'white', boxSizing: 'border-box' }}>
            <tr>
